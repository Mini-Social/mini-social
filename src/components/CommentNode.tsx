...
const CommentNode = ({
  ...
  const handleReplyComment = async () => {
    ...
    const actualContent = fullText.replace(replyTarget.name, '').trim();
          ...
          <div className="relative">
            ...
            >
              <CommentItem
                ...
                setParentCommentId={(id: string | null) =>
                  setParentCommentId(id)
                }
                setReplyTarget={
                  depth >= 2 ? setGlobalReplyTarget : setReplyTarget
                }
              />
              {/* Đệ quy */}
              {(depth < 2
            ...
            >
              ...
              >
                ...
                <div className="flex w-full items-center justify-between rounded-[12px] bg-(--background-primary) px-2 py-1.5">
                  ...
                  <div className="mt-auto" onClick={handleReplyComment}>
                    <img
                      src={SendIcon}
                      alt=""
