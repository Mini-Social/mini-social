...
const conversations = [
  ...
  // 4. Nhóm Gia Đình (Nhiều tin nhắn chưa đọc)
  {
    ...
    members: [
      '65a8ef88e9b1a12f9c000111',
      '65a8ef55e9b1a12f9c000555',
      '65a8ef44e9b1a12f9c000666',
      '65a8ef33e9b1a12f9c000777',
    ],
    type: 'group',
  ...
  // 6. Nhóm nhậu (Tin nhắn cũ)
  {
    ...
    members: [
      '65a8ef88e9b1a12f9c000111',
      '65a8ef11e9b1a12f9c000999',
      '65a8ef00e9b1a12f9c001010',
    ],
    type: 'group',
      ...
      <div className="xs:no-scrollbar custom-scrollbar flex flex-1 flex-col overflow-y-auto">
        {filterConversations.map(convo => (
          <Conversation
            ...
            lastSenderId={
              convo.lastSenderId === myId ? 'You' : convo.lastSenderId
            }
            unReadCount={
