...
const userPhotos = [
  {
    id: 'p1',
    url: 'https://images.pexels.com/photos/15286/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p2',
    url: 'https://images.pexels.com/photos/3244513/pexels-photo-3244513.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p3',
    url: 'https://images.pexels.com/photos/3408744/pexels-photo-3408744.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p4',
    url: 'https://images.pexels.com/photos/572897/pexels-photo-572897.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p5',
  ...
  {
    id: 'p7',
    url: 'https://images.pexels.com/photos/1382731/pexels-photo-1382731.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p8',
    url: 'https://images.pexels.com/photos/1674752/pexels-photo-1674752.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
    id: 'p9',
...
const Profile = () => {
  ...
  //   relationship: 'Single',
  // });
  const isProfileOwner = user?.userName === id;
  return (
    <div className="mx-auto flex max-w-[1000px] flex-col">
      ...
      <div className="flex flex-col items-center">
        <span className="text-2xl font-bold">{user && user?.firstName + " " + user?.lastName}</span>
        {
          !isProfileOwner && <div className="mt-2 flex gap-2">
      ...
      <div className="flex flex-col py-5 md:flex-row md:gap-5 md:px-5">
        ...
        <div className="flex-5">
          <Share />
          {/* <div className="p-5 rounded-xl shadow-[0_0_4px_0px_rgba(0,0,0,0.2)] bg-background text-(--textColor) mb-5">
            <div className="flex items-center justify-between">
              <h4 className="text-[16px] font-bold">Posts</h4>
              <span className="text-[14px] text-(--textColor2) hover:underline cursor-pointer">{10} Posts</span>
            </div>
            </div> */}
          <Posts />
          {isVisible && (
